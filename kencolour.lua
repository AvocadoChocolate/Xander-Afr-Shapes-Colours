...
local function play(part)
    ...
    if part == "rooi" then
        playPart(0,700)
    elseif part == "blou" then
        playPart(800,500)
    elseif part == "groen" then
        playPart(1200,500)
    elseif part == "geel" then
        playPart(1800,700)
    elseif part == "pers" then
        playPart(2500,600)
    elseif part == "oranje" then
        playPart(3400,800)
    end
end
...
local t1 = {text="blou",image="blou.png",sound="vwortel.mp3"}
local t2 = {text="oranje",image="oranje.png",sound="vboontjie.mp3"}
local t3 = {text="rooi",image="rooi.png",sound="vkomkommer.mp3"}
local t4 = {text="geel",image="geel.png",sound="vuie.mp3"}
local t6 = {text="groen",image="groen.png",sound="vsoetrisse.mp3"}
local t5 = {text="pers",image="pers.png",sound="vspinasie.mp3"}
