...
local function play(part)
    print(part)
    if part == "vierkant" then
        playPart(860,800)
    elseif part == "driehoek" then
        playPart(2600,800)
    elseif part == "hart" then
        playPart(4000,900)
    elseif part == "sirkel" then
        playPart(0,700)
    elseif part == "reghoek" then
        playPart(1700,900)
    elseif part == "ster" then
        playPart(3200,800)
    end
end
...
local t1 = {text="vierkant",image="vierkant.png",sound="vwortel.mp3"}
local t2 = {text="driehoek",image="driehoek.png",sound="vboontjie.mp3"}
local t3 = {text="hart",image="hart.png",sound="vkomkommer.mp3"}
local t4 = {text="sirkel",image="sirkel.png",sound="vuie.mp3"}
local t6 = {text="ster",image="ster.png",sound="vsoetrisse.mp3"}
local t5 = {text="reghoek",image="reghoek.png",sound="vspinasie.mp3"}
